...
class AboutAttributeAccess(Koan):
    ...
    def test_all_attribute_reads_are_caught(self):
        ...
        self.assertEqual(catcher.foobar, "Someone called 'foobar' and it could not be found")

    def test_intercepting_return_values_can_disrupt_the_call_chain(self):
        catcher = self.CatchAllAttributeReads()

        self.assertEqual(catcher.foobaz, "Someone called 'foobaz' and it could not be found") # This is fine
        ...
        self.assertEqual(err_msg, "'str' object is not callable")
    ...
    def test_changes_to_the_getattribute_implementation_affects_getattr_function(self):
        ...
        self.assertEqual(getattr(catcher, 'any_attribute'), "Someone called 'any_attribute' and it could not be found")
